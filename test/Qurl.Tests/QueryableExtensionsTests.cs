...
namespace Qurl.Tests
{
    public class QueryableExtensionsTests
    {
        ...
        public void TestEqualsFilterIntProperty()
        {
            ...
            var query = new Query<SampleObject>();
            query.AddFilter(m => m.Prop1, new EqualsFilter<int>(prop1FilterValue));
        ...
        public void TestEqualsFilterStringProperty()
        {
            ...
            var query = new Query<SampleObject>();
            query.AddFilter(m => m.Prop2, new EqualsFilter<string>(prop2FilterValue));
        ...
        public void TestInFilterIntProperty()
        {
            ...
            var query = new Query<SampleObject>();
            query.AddFilter(m => m.Prop1, new InFilter<int>(prop1FilterValues));
        ...
        public void TestBetweenFilterDateTimeProperty()
        {
            ...
            var query = new Query<SampleObject>();
            query.AddFilter(m => m.Prop4, new FromToFilter<DateTime>(dateTimeFrom, dateTimeTo));
        ...
        public void TestContainsFilter()
        {
            ...
            var query = new Query<SampleObject>();
            query.AddFilter(m => m.Prop2, new ContainsFilter(searchValue));
        ...
        public void TestStartsWithFilter()
        {
            ...
            var query = new Query<SampleObject>();
            query.AddFilter(m => m.Prop2, new StartsWithFilter(searchValue));
        ...
        public void TestEndsWithFilter()
        {
            ...
            var query = new Query<SampleObject>();
            query.AddFilter(m => m.Prop2, new EndsWithFilter(searchValue));
        ...
        public void SortWithNestedProperty(bool ascending)
        {
            ...
            query.AddSort("Prop1.Prop2", ascending);
        ...
        public void DefaultSortWithInvalidPropertyNameShouldNotThrowException(bool ascending)
        {
            ...
            query.AddSort("test_prop", ascending);
